...
const QList<Sorter*>& SorterContainer::sorters() const
{
    return m_sorters;
}
...
SorterContainer::q_size_type SorterContainer::count_sorter(QQmlListProperty<Sorter>* list)
{
    QList<Sorter*>* sorters = static_cast<QList<Sorter*>*>(list->data);
    return sorters->count();
}

Sorter* SorterContainer::at_sorter(QQmlListProperty<Sorter>* list, SorterContainer::q_size_type index)
{
    QList<Sorter*>* sorters = static_cast<QList<Sorter*>*>(list->data);
