...
const QList<Filter*>& FilterContainer::filters() const
{
    return m_filters;
}
...
FilterContainer::q_size_type FilterContainer::count_filter(QQmlListProperty<Filter>* list)
{
    QList<Filter*>* filters = static_cast<QList<Filter*>*>(list->data);
    return filters->count();
}

Filter* FilterContainer::at_filter(QQmlListProperty<Filter>* list, FilterContainer::q_size_type index)
{
    QList<Filter*>* filters = static_cast<QList<Filter*>*>(list->data);
