...
const QList<ProxyRole*>& ProxyRoleContainer::proxyRoles() const
{
    return m_proxyRoles;
}
...
ProxyRoleContainer::q_size_type ProxyRoleContainer::count_proxyRole(QQmlListProperty<ProxyRole>* list)
{
    QList<ProxyRole*>* ProxyRoles = static_cast<QList<ProxyRole*>*>(list->data);
    return ProxyRoles->count();
}

ProxyRole* ProxyRoleContainer::at_proxyRole(QQmlListProperty<ProxyRole>* list, ProxyRoleContainer::q_size_type index)
{
    QList<ProxyRole*>* ProxyRoles = static_cast<QList<ProxyRole*>*>(list->data);
